	...
	<div class="container">
		...
		<div class="content-md container-sm border-bottom-1">
			<div class="row">
				...
				<div class="col-sm-5">
					<img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/about1.png" alt="">
				</div>
			</div>
			<!--// end row -->
		</div>
							...
							<div class="overflow-h">
								...
								<div class="team-v2 wow fadeInLeft" data-wow-duration=".2" data-wow-delay=".2s">
									<div class="team-v2-img-gradient">
										<img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/members/06.jpg" alt="">
									</div>
						...
						<div class="col-xs-6 xs-full-width">
							<div class="overflow-h">
								...
								<div class="team-v2 wow fadeInLeft" data-wow-duration=".2" data-wow-delay=".1s">
									<div class="team-v2-img-gradient">
										<img class="img-responsive" src="<%=request.getContextPath() %>/templates/public/img/members/07.jpg" alt="">
									</div>
									<div class="team-v2-content">
										<div class="team-v2-center-align">
