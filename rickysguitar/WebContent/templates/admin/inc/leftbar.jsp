...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a id="product" href="<%=request.getContextPath()%>/admin-product"><i class="fa fa-music fa-3x" aria-hidden="true"></i> Quản lý sản phẩm</a>
            </li>
            <li>
                <a id="order" href="<%=request.getContextPath()%>/admin-order"><i class="fa fa-shopping-cart fa-3x" aria-hidden="true"></i> Quản lý đơn hàng</a>
            </li>
            <li>
